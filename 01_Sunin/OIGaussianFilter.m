function J = OIGaussianFilter(I, kerneldiameter, mask)
...
maskoutsame=1;	 % "1": keep the masked region the same in output matrix as in input matrix, "0" for filtered (takes time)
...
cfilter=fspecial('gaussian', Kernel,floor(Kernel/2));
