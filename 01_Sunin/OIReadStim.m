...
% For OI data processing, read one stim (condition) from one block into a 3-D matrix
% AllFrames=OIReadStim(blkfilename, stim, system)
% Input: 'blkfilename' including the path, 'system' is either 'v' or 'r', stim is the stim number to read
% Return: 'AllFrames', a 3-D matrix, in order of [Height, Width, Nframe]
...
% if stim>NConds
%     fprintf('\rError: stim wish to read exceed cond num in OIReadStim!\r');
% end
