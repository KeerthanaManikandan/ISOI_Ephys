function J = HROIDiskFilter_org(I, kerneldiameter, mask)
...
maskoutsame=0;	 % "1": keep the masked region the same in output matrix as in input matrix, "0" for filtered (takes time)
