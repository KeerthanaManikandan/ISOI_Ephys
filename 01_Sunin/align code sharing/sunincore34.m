...
resultfolder=[resultdriver, '00_expresult\', expname, runname(1:end-1), '.', ext, '\'];
...
if ~isdir(resultfolder)
    mkdir([resultdriver, '00_expresult\', expname], [runname(1:end-1), '.', ext, '\']);    
end
...
%     [sfname, sfblock, sfstim, sfframe, sfx1, sfy1, sfcoor]=textread(strcat(resultfolder, 'shiftinput.2.txt'), '%s %d %d %d %f %f %f');
    [sfname, sfblock, sfstim, sfframe, sfx1, sfy1, sfcoor]=textread(strcat(blockfolder, 'shiftinput.2.txt'), '%s %d %d %d %f %f %f');
