...
% Codes for ISOI_Ephys Paper Figure 7 (A&B)
...
if  ~exist([templateDir '\longitudinalFCMaps.mat'],'file')
    for iDate = 1:size(checkDates,1)
        ...
        parfor iSeed = 1:size(seedLocNonLinear,1)
    ...
    save([templateDir '\longitudinalFCMaps.mat'],'corrFC_Avg_SessionWise','seedLocNonLinear',...
        'greenMapRef','checkDates');
else
    load([templateDir '\longitudinalFCMaps.mat'],'corrFC_Avg_SessionWise','seedLocNonLinear',...
        'greenMapRef','checkDates');
end
