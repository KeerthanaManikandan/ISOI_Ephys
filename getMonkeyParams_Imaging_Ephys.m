...
elseif strcmp(monkeyName,'Whiskey') % Whiskey
    allDates = ['08_14_2023'; '10_16_2023'; '12_04_2023';'02_20_2024';'04_29_2024'];
    allRuns  = {['run02'; 'run04'; 'run05';];[ 'run03'; 'run04'; 'run05'; ...
        'run06'; 'run07'; 'run08'; 'run09'];['run04'; 'run05';'run06'; 'run07']; ...
        ['run01'; 'run02';'run03'; 'run04'; 'run05'; 'run06'; 'run07'];['run01'; ...
        'run02'; 'run04'; 'run05'; 'run06'; 'run07'; 'run08']};
    ...
    lensCombo        = {['28/50'; '28/50'; '28/50'];[ '50/80 MF'; '50/80 MF'; '50/80 MF'; ...
        ...
        ['50/80 MF'; '50/80 MF';'50/80 MF'; '50/80 MF';'50/80 MF' ; '50/80 MF'; '50/80 MF'];...
          ['50/80 MF'; '50/80 MF';'50/80 MF'; '50/80 MF';'50/80 MF' ; '50/80 MF'; '50/80 MF']};
    roiSize          = {[36 36 36];[38 38 38 38 38 38 38];[38 38 38 38];[38 38 38 38 38 38 38];...
        [38 38 38 38 38 38 38]}; % for 500 um x 500 um
    ...
    ephysFileNameAll = {['datafile0002'; 'datafile0004'; 'datafile0005']; ['datafile0003' ;...
        ...
        'datafile0004'; 'datafile0005'; 'datafile0006'; 'datafile0007';'datafile0008' ]; ['datafile0002'; ...
        'datafile0003'; 'datafile0005'; 'datafile0006'; 'datafile0007';'datafile0008';'datafile0009' ]};
    ...
    probeLabel       = {[]; ['CDE1';'B25A'; 'B25A'; 'B25A'; 'B25A'; 'B25A' ;'B25A'];['B25A'; 'B25A'; '0763'; '0763'];...
        ['0763'; '0763'; '0763'; '0763'; '0763'; '0763'; '0763']; ['0763'; '0763'; '0763'; '0763'; '0763'; '0763'; ...
        '0763']};
    chInCortexNotes  = {[1 1 1]; [5 5 7 4 5 5 6];[6 6 8 5]; [7 6 6 8 7 7 9]; [6 3 6 6 6 8 7]}; % transition determined during experiment
end
