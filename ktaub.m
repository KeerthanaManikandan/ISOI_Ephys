...
% and Sen痴 Slope written in Mathworks-MATLAB implemented using matrix
% rotations.
%
% Suggested citation:
%
% Burkey, Jeff. May 2006.  A non-parametric monotonic trend test computing 
%      Mann-Kendall Tau, Tau-b, and Sen痴 Slope written in Mathworks-MATLAB 
...
%
% Update 8/27/2013: Dr. Dennis Helsel has published a book that describes in
% great detail how one should address datasets with censored data (e.g.
% non-detects for water quality monitoring). His efforts make a compelling
% argument for NOT using Tau-b methodology.  Rather, missing data should be
% addressed with more sophisticated techniques prior to running trend statistics.
